...
namespace Chimera {
    inline void set_extended_api_functions(lua_State *state) noexcept {
        ...
        lua_register(state, "get_object_node_count", lua_api_get_object_node_count);
        lua_register(state, "get_object_node_info", lua_api_get_object_node_info);
        lua_register(state, "get_object_node_definition", lua_api_get_object_node_definition);
        lua_register(state, "get_item_info", lua_api_get_item_info);
